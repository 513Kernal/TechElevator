...
public class OldMacdonald {
	public static void main(String[] args) {
		...
		eric.makeSound();
		((Chicken) eric).layEgg(); //casts to show chicken

		Chicken clucker = (Chicken) eric; //casts to show its a chicken  not every singable is a chicken
		FarmAnimal critter = clucker; //every chicken is a farm animal
