...
public class Card {
    ...
    private final String suit; //final sets once and locks value
    ...
    public Card(){   //prevents null rank/suit
        suit = "Spades";
        rank = "Ace";
    ...
    //this was done to show what final does
    //public void makeItHearts(){
    //    this.suit = "Hearts";
    //}
