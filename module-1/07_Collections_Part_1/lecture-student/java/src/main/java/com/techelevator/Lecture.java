...
public class Lecture {
	...
	public List<String> insertAfterFirst(List<String> names, String name) {
		...
		result.add(1, name);
		//makes copy of original list without changing original list*****
	...
	public String[] trimArray(String[] input) {
		//List<String> fixedSizeCopy = Arrays.asList(input);
		...
		String[] result = copy.toArray(new String[0]); //convert list to array
