...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		String output = out.substring(0,2);
		String output1 = out.substring(2,4);

		return output + word +output1;
	}
	...
	public String extraEnd(String str) {
		int answerEnd = str.length();




		return str.substring(answerEnd - 2, answerEnd) + str.substring(answerEnd - 2, answerEnd) + str.substring(answerEnd- 2, answerEnd);
	}
	...
	public String middleTwo(String str) {
		return str.substring((str.length()/2)-1, 1 + (str.length()/2));
	...
	public String stringBits(String str) {
		...
		for (int i=0; i<str.length(); i= i+2){
			resultOf = resultOf + str.charAt(i);
	...
	public String stringSplosion(String str) {
		...
		for (int i=0; i <str.length()+1; i =i +1){
			spolsion = spolsion + str.substring(0,i);
	...
	public int last2(String str) {
		...
		String counter1 = str.substring(str.length()-2, str.length());
		int counter2 = 0;

		for (int i=0; i <str.length() - 2; i=i+1){
			if (str.substring(i,i+2).equals(counter1)){
				counter2 = counter2 + 1;
			}
		}
		return counter2;
