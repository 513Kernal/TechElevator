...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		byte percentageBattery = 100;

		int intPercent = percentageBattery;

		percentageBattery = (byte) intPercent
		...
		*/
		...
		System.out.println(1_000_000_000L * 3);
